...
/**
 * DB Class (https://github.com/joshcam/PHP-MySQLi-Database-Class)
 *
...
class DB
{
     ...
     * @param int $port
     */
    protected function __construct($host = NULL, $username = NULL, $password = NULL, $db = NULL, $port = NULL, $charset = 'utf8')
    {
        $isSubQuery = false;
    ...
    public static function getInstance()
    {
        if (self::$_instance == null) {
            return new DB(Config::db_host, Config::db_user, Config::db_password, Config::db_name, Config::db_port);
        }
        else {
    ...
    public function completeRawQuery($query){
